...
package com.threetree.ttrefreshrecyclerview.base;
...
import com.threetree.ttrefreshrecyclerview.HTRecyclerViewDragListener;
import com.threetree.ttrefreshrecyclerview.HTRefreshListener;
import com.threetree.ttrefreshrecyclerview.R;
import com.threetree.ttrefreshrecyclerview.utils.Utils;
import com.threetree.ttrefreshrecyclerview.viewimpl.HTDefaultHorizontalRefreshViewHolder;
...
import static com.threetree.ttrefreshrecyclerview.base.HTOrientation.VERTICAL_DOWN;
import static com.threetree.ttrefreshrecyclerview.base.HTOrientation.VERTICAL_UP;
...
//        setRecyclerViewOnTouchListener();
    ...
    private void setViewLayoutParams(View view) {
        if (view == null) return;
        LayoutParams lp = view.getLayoutParams() == null ? new LayoutParams(0, 0) : view.getLayoutParams();
